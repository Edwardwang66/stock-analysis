...
| `tests.yml` | Gate frontend and Python contracts | Push to `main` ignoring `feed/crypto/**`, `feed/factory/**`, `feed/funds/**`, `feed/health.json`, `feed/index.json`, `feed/intraday/**`, `feed/market/**`, `feed/reports/**`, `feed/screener/**`, `feed/signals/**`, `feed/stock-notes/**`, `feed/watchlist.json`; every pull request; dispatch | Frontend lint, typecheck, tests, static/server builds and smokes; Python 3.11.15 and 3.12.13 lock/tests; aggregate gate | CI checks only | `contents: read` | `ci-${{ github.ref }}`; cancel true | `.node-version`, exact Node/npm, Python matrix and locks, internal Next, pip, Python, and result values; no secrets |
