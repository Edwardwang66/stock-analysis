# Universe 下沉实验(D5 容量护城河,2026-09-02)

同一引擎、同一默认参数(零调参 R5),大盘拥挤层 vs S&P600 下沉层(分层抽样,seed 预注册)。

| 层 | N | 毛SR | 净SR | train | holdout | 成本拖累 | 实现毛杠杆 | 日换手 |
|---|---|---|---|---|---|---|---|---|
| 大盘 S&P500 拥挤层 | 115 | +0.03 | -0.35 | -0.20 | -0.62 | 1.1%/年 | 0.50 | 8% |
| 小盘 S&P600 下沉层 | 117 | +0.19 | -0.26 | -0.14 | -0.48 | 1.3%/年 | 0.35 | 5% |

毛 Sharpe 下沉增益:+0.16;净 Sharpe 增益:+0.09。
容量地板绑定:小盘实现毛杠杆 0.35(目标 1.0) vs 大盘 0.50 —— 地板把规模诚实地压下来,这正是护城河的另一面。
